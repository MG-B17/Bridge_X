...
import 'package:bridge_x/feature/view_task/presentation/widgets/completed_task_card.dart';
import 'package:bridge_x/feature/view_task/presentation/widgets/in_progress_task_card.dart';
import 'package:bridge_x/feature/view_task/presentation/widgets/task_section_header.dart';
import 'package:bridge_x/feature/view_task/presentation/widgets/todo_task_card.dart';
import 'package:bridge_x/feature/view_task/presentation/widgets/view_task_project_card.dart';
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Tasks assigned inside ${data.teamName}',
                maxLines: 1,
      ...
      children: [
        if (inProgress.isNotEmpty) ...[
          ...
          ...inProgress.map((t) => Padding(
                ...
                child: InProgressTaskCard(task: t, assignedName: firstMember),
              )),
        ],
        if (todo.isNotEmpty) ...[
          ...
          ...todo.map((t) => Padding(
                padding: EdgeInsets.only(bottom: AppSpacing.spacing12),
                child: TodoTaskCard(task: t, assignedName: firstMember),
              )),
        ],

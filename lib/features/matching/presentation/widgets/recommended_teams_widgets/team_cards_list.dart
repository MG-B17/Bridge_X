...
import 'package:bridge_x/features/matching/domain/entities/team_recommendation_entity.dart';
import 'team_card.dart';

class TeamCardsList extends StatelessWidget {
  final List<TeamRecommendationEntity> recommendations;
  final void Function(int teamId)? onRequestJoin;
        ...
        ...recommendations.map((rec) {
          return Padding(
            ...
            child: TeamCard(
              ...
              teamId: rec.teamId,
              onRequestJoin: onRequestJoin != null
                  ? () => onRequestJoin!(rec.teamId)
                  : null,
            ),
          );
        }),

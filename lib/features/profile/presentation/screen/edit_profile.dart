        ...
        listener: (context, state) {
          ...
          if (state is EditProfileUpdated) {
            ...
            if (widget.isSetupMode) {
              ...
              final currentUserData = appState.userData;
              if (currentUserData != null) {
                final updated = currentUserData.copyWith(
                  userName: state.profile.userName,
                  isProfileComplete: true,
                );
                appState.userData = updated;
                sl<SecureStorageService>().write(
                  key: AppKeys.userDataKey,
                  value: UserDataModel.userEncodedata(userDataModel: updated),
                );
              }
              if (context.mounted) context.goNamed(BridgeXRouteNames.home);
            } else {

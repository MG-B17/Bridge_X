...
import 'package:bridge_x/features/team_managment/create_team/presentation/widgets/create_team_widgets/create_team_form_content.dart';
...
class _CreateTeamScreenState extends State<CreateTeamScreen> {
  ...
  void _showLoadingDialog() {
    if (!_isLoadingDialogShowing) {
      ...
      LoadingDialog.show(context: context, message: CreateTeamStrings.creatingTeam).then((
        _,
      ) {
        _isLoadingDialogShowing = false;
      });
        ...
        listener: (context, state) {
          if (state.status == CreateTeamStatus.loading) {
            ...
            SuccessDialog.show(
              ...
              message: CreateTeamStrings.teamCreatedSuccessfully,
              onAction: () {

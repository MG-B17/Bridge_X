...
import 'package:bridge_x/features/team_managment/create_team/presentation/widgets/search_helper_content.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  BridgeXTextFormField(
                    ...
                    hint: CreateTeamStrings.searchTeamMembers,
                  ...
                  //NoUserFoundedWidget(),
                  VerticalSpacing(AppSpacing.height32),
                  BridgeXButton(text: CreateTeamStrings.sendInvitation, onTap: () {}),

...
export 'package:bridge_x/features/team_managment/my_tasks/data/models/models/task_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    switch (task.status) {
      ...
      case TaskStatus.nearCompletion:
        ...
        statusText = TaskStrings.nearCompletion.toUpperCase();
        break;
      case TaskStatus.completed:
        statusColor = context.colors.success;
        statusBgColor = context.colors.success.withValues(alpha: 0.1);
        statusText = TaskStrings.completed.toUpperCase();
        break;
    }
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  '${TaskStrings.dueDate} ${task.dueDate}',
                  style: context.textTheme.bodyMedium?.copyWith(
                    color: context.colors.textSecondary,
                  ),
                ),

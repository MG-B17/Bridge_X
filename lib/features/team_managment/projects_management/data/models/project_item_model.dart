import 'package:bridge_x/features/team_managment/projects_management/data/models/project_team_model.dart';
...
class ProjectItemModel {
  ...
  final bool isLeader;
  final ProjectTeamModel? yourTeam;
  ...
  factory ProjectItemModel.fromJson(Map<String, dynamic> json) {
    return ProjectItemModel(
      ...
      yourTeam: json['your_team'] != null
          ? ProjectTeamModel.fromJson(json['your_team'] as Map<String, dynamic>)
          : null,
    );
  }

...
import 'package:bridge_x/features/team_managment/projects_management/presentation/widgets/details_screen_widgets/team_member_avatar.dart';
      ...
      children: [
        Row(
          children: [
            ...
            Text(
              '$teamMembersCount ${ProjectStrings.active}',

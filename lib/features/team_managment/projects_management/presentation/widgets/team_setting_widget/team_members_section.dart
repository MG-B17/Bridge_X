...
import 'package:bridge_x/features/team_managment/projects_management/presentation/widgets/team_setting_widget/team_member_card.dart';
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            SectionHeader(title: ProjectStrings.membersManagement.toUpperCase()),
            Container(
              ...
              child: Text(
                '${members.length} ${ProjectStrings.teamMembers.toUpperCase()}',
        ...
        if (members.isEmpty)
          Container(
            ...
            child: Center(
              child: Text(
                ProjectStrings.noMembersInTeam,
          ...
          ...members.map((member) => TeamMemberCard(
            member: member,
            projectId: projectId,
          )),
      ],

...
import 'create_task_form_fields.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            const CreateTaskLabel(text: TaskStrings.assignTo, isRequired: true),
            const Spacer(),
            Text(AppStrings.viewAll, style: AppTextStyles.labelSmall.copyWith(color: colors.secondary, fontWeight: FontWeight.w600)),
          ],
        ),
        VerticalSpacing(AppSpacing.spacing8),
        BridgeXTextFormField(hint: TaskStrings.searchTeamMembers, controller: searchController, prefixIcon: Icons.search),
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          ...
          VerticalSpacing(AppSpacing.spacing4),
          Text(TaskStrings.add, style: AppTextStyles.labelSmall.copyWith(color: colors.textSecondary)),
        ],
      ),
    );
  }

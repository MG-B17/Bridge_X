...
class TagsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(TaskStrings.tags, style: AppTextStyles.titleMedium.copyWith(color: colors.textPrimary, fontWeight: FontWeight.w600)),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(TaskStrings.tag, style: AppTextStyles.labelSmall.copyWith(color: colors.textSecondary)),
                      ],
                    ),
                  ),
                ),
  ...
  void _showAddTagDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text(TaskStrings.addTag),
        content: TextField(
          controller: tagController,
          autofocus: true,
          decoration: const InputDecoration(hintText: TaskStrings.enterTagName),
          onSubmitted: (value) {
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text(TaskStrings.add),
          ),
        ],
      ),
    );

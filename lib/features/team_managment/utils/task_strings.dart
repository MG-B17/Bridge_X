class TaskStrings {
  ...
  static const String selectMemberFirst = 'Please select a team member first';
  static const String selectDateFirst = 'Please select a due date first';
  static const String failedToLoadMembers = 'Failed to load members';
